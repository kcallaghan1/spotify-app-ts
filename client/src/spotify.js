...
const getAccessToken = () => {
    ...
    if (hasError || hasTokenExpired() || LOCALSTORAGE_VALUES.accessToken === 'undefined' || LOCALSTORAGE_VALUES.accessToken === false) {
        refreshToken();
    }
 ...
 * https://developer.spotify.com/documentation/web-api/reference/#/operations/get-a-list-of-current-users-playlists
 * @param {string} time_range - 'short_term' (last 4 weeks) 'medium_term' (last 6 months) or 'long_term' (calculated from several years of data including all new data as it becomes available.) Defaults to 'short_term'
 * @returns {Promise}
 */
